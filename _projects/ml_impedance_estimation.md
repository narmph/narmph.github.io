...
<div class='row'>
    <div class="col-sm-8 mt-3 mt-md-0">
        ...
        <p><strong>lab:</strong> <a href="https://neurobionics.robotics.umich.edu">Neurobionics lab at the University of Michigan</a><br>
        <strong>advisor:</strong> <a href="https://me.engin.umich.edu/people/faculty/elliott-rouse/">Dr. Elliott Rouse</a><br>
        <strong>recent work: </strong> <a href="{{ '/assets/pdf/mmls.pdf' | relative_url }}" class="mybtn btn-sm z-depth-0" role="button">poster</a></p>
        <hr>
        <p>
